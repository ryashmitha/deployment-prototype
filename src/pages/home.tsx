...
export default function Home() {
  ...
  const pages = [
    { title: 'Deployment Board', path: '/', description: 'Automated deployment flow — 5-column kanban with chat panel, validation, and deploy' },
    { title: 'Kanban Board', path: '/kanban', description: 'Project management board with lists, cards, and task checklists' },
  ]
